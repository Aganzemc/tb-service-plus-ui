          ...
          <div className="max-w-[760px]">
            ...
            <Reveal delay={180}>
              <p className="mt-6 max-w-3xl text-[17px] leading-8 text-white/82 md:text-[20px] md:leading-9">
                TB Service Plus helps homes and small businesses with dependable local support, direct communication,
                and practical service for the jobs that need to get done.
              </p>
            </Reveal>
